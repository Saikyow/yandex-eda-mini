...
public class KafkaConfiguration {
    ...
    public ConsumerFactory<Long, DeliveryAssignedEvent> deliveryAssignedEventConsumerFactory(KafkaProperties kafkaProperties) {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "fedor.dev.api.kafka");
        return new DefaultKafkaConsumerFactory<>(props);
    }

    @Bean
    public KafkaListenerContainerFactory<?> deliveryAssignedEventListenerFactory(ConsumerFactory<Long, DeliveryAssignedEvent> orderPaidEventConsumerFactory) {
